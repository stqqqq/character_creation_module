...
def attack(char_name: str, char_class: str) -> int:
    """Определяет нанесенный урон противнику."""
...
def defence(char_name: str, char_class: str) -> int:
    """Определяет сколько урона заблокированно."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> int:
    """Опредляет какой специальное умение применил игрок."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Определяет кто твой персонаж и позволяет провести тренировку."""
    if char_class == 'warrior':
...
def choice_char_class():
    """Определяет за какой класс персонажа играть пользователю."""
    approve_choice = None
    char_class = None
